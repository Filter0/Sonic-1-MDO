...
LZWaterFeatures:
		tst.b	(f_water).w ; check if there is any water
...
@chksonic:
		...
		jsr	PlaySound_Special(pc)	; play rushing water sound (only every $40 frames)
...
loc_3F9A:
		...
		bne.s	locret_3FBE
		move.w	#sfx_Waterfall,d0
		jmp	PlaySound_Special(pc)	; play water sound
